...
im1=Image.open(refFilename).convert('RGB')
im1=np.array(im1)
placeholder = st.write("The input image must be exactly the same as this form")
placeholder = st.image(im1)
